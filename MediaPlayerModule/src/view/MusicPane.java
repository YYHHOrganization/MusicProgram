...
//        sldVolume.setPrefHeight(10);
	...
	public static void generateSongsInSonglist(SelectSongsInSonglist songs) {
		...
		for (int i = 0; i < songSize; i++) {
			...
			int singerId = songs.getSongs().get(i).getAsong().getSinger_id();
			...
			musicLabel1.getLabel().setPrefWidth(100);
			...
			musicLabel2.getLabel().setPrefWidth(100);
			...
			musicLabel3.getLabel().setPrefWidth(100);
			...
			musicLabel4.getLabel().setPrefWidth(100);
...
/*	public static void readAllSound()
	{
		System.out.println("hello world");
