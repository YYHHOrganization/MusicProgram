...
public class PlayBean {
   ...
   // private String artist;//演唱家
    ...
    public PlayBean(int id, String soundName, MusicLabel artist, String album, String length, String time, Label labDelete, WritableImage image, int totalSeconds, String filePath, MediaPlayer mediaPlayer, String lrcPath) {
        this.id = id;
    ...
    public MusicLabel getArtist() {
        return artist;
    }

    public void setArtist(MusicLabel artist) {
        this.artist = artist;
    }
